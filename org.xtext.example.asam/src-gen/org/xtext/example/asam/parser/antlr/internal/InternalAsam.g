...
@after {
	...
	(
		...
		{
			$current = $this_Repository_3.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_EntityRelationship_4.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
// Rule ParamTrasfert
ruleParamTrasfert returns [Enumerator current=null]
@init {
	enterRule();
}
@after {
