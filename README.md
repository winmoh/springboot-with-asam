...
the images below would show the structure of the output and also the content if each file in the project generator to help the user understand more ASAM:<br>
