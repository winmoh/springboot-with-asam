...
public class AsamParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AsamGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getParamTrasfertAccess().getAlternatives(), "rule__ParamTrasfert__Alternatives");
			...
			builder.put(grammarAccess.getControllerAccess().getGroup_7(), "rule__Controller__Group_7__0");
			...
			builder.put(grammarAccess.getEntityAccess().getIdentAssignment_4(), "rule__Entity__IdentAssignment_4");
			builder.put(grammarAccess.getEntityAccess().getPropertiesAssignment_5(), "rule__Entity__PropertiesAssignment_5");
			builder.put(grammarAccess.getEntityAccess().getRepoAssignment_6(), "rule__Entity__RepoAssignment_6");
			builder.put(grammarAccess.getEntityAccess().getControlAssignment_7(), "rule__Entity__ControlAssignment_7");
			builder.put(grammarAccess.getIdentifierAccess().getNomAssignment_1(), "rule__Identifier__NomAssignment_1");
			...
			builder.put(grammarAccess.getControllerAccess().getEntityAssignment_2(), "rule__Controller__EntityAssignment_2");
			builder.put(grammarAccess.getControllerAccess().getBaseUrlAssignment_4(), "rule__Controller__BaseUrlAssignment_4");
			builder.put(grammarAccess.getControllerAccess().getCactionsAssignment_5(), "rule__Controller__CactionsAssignment_5");
			builder.put(grammarAccess.getControllerAccess().getCparamAssignment_6_2(), "rule__Controller__CparamAssignment_6_2");
			builder.put(grammarAccess.getControllerAccess().getFparamAssignment_7_2(), "rule__Controller__FparamAssignment_7_2");
			builder.put(grammarAccess.getControllerAccess().getDparamAssignment_8_2(), "rule__Controller__DparamAssignment_8_2");
			...
			builder.put(grammarAccess.getCustomActionAccess().getNomAssignment_2(), "rule__CustomAction__NomAssignment_2");
