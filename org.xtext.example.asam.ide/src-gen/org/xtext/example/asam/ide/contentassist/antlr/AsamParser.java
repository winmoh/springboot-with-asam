...
public class AsamParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AsamGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getControllerAccess().getCactionsAssignment_3(), "rule__Controller__CactionsAssignment_3");
			builder.put(grammarAccess.getControllerAccess().getCparamAssignment_4_2(), "rule__Controller__CparamAssignment_4_2");
			builder.put(grammarAccess.getControllerAccess().getFparamAssignment_5_2(), "rule__Controller__FparamAssignment_5_2");
			builder.put(grammarAccess.getControllerAccess().getDparamAssignment_6_2(), "rule__Controller__DparamAssignment_6_2");
