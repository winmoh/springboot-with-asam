...
public class AsamParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AsamGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSbootAccess().getNameAssignment_1(), "rule__Sboot__NameAssignment_1");
			...
			builder.put(grammarAccess.getDatabaseInfoAccess().getNameAssignment_5(), "rule__DatabaseInfo__NameAssignment_5");
			...
			builder.put(grammarAccess.getControllerActionAccess().getNameAssignment_2(), "rule__ControllerAction__NameAssignment_2");
